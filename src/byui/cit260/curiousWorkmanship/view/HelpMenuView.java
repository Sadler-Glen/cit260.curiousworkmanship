        ...
        switch (choice) {
            ...
            case 'T':
                System.out.println("\n"
                        ...
                        + "\nwill be moved to the new location if there are no"
            ...
            case 'E':
                System.out.println("\n"
                        ...
                        + "\nfor the recommended amount per person. You will then"
                        + "\nhave to figure how much can be stored in the barrels"
                        + "\ndesigned to hold the selected type of resource "
                        + "\nyou are planning for. You will have to go back to the"
            ...
            case 'P':
                System.out.println("\n"
                        ...
                        + "\nselect an indvidual to work on packing the ship"
            ...
            case 'J':
                System.out.println("\n"
                        ...
                        + "\nand loaded the ship with all of the required resources"
                        + "\nbefore you start your journey. Select the Launch"
                        + "\nship option on the Game Menu. If the ship is"
